...
default_alphabet = "air bat cap drum each fine cost harp ink joke crunch look made near orc pit quench red soup trap urge vest whale taxi yank zebra".split(
    " "
)
