...
ctx.lists["self.pascal_sections"] = {
    "uses": "uses",
    "constant": "const",
    "type": "type",
    "interface": "interface",
...
mod.list("pascal_sections", desc="Pascal unit sections")
...
@mod.capture(rule="{self.pascal_sections}")
def pascal_section(m) -> str:
    "Returns a string"
    return m.pascal_sections
...
class UserActions:
    ...
    def code_operator_bitwise_exclusive_or():
        actions.auto_insert(" xor ")

    def code_operator_bitwise_exclusive_or_assignment():
        actions.auto_insert("")

    def code_operator_bitwise_left_shift():
        actions.auto_insert(" lsh ")

    def code_operator_bitwise_left_shift_assignment():
        actions.auto_insert("")

    def code_operator_bitwise_right_shift():
        actions.auto_insert(" rsh ")
